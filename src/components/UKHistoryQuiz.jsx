...
import ukHistoryQuestions from '../data/ukHistoryQuestions';
...
const correctSnarkyComments = [
    ...
    "Well, look at you!",
    "I say old chap, you really know the UK well.",
    "Somebody's been studying!",
    "You just guessed that one, didn't you?",
    "I'm almost impressed.",
    "You Googled that one, didn't you?",
...
const wrongSnarkyComments = [
    ...
    "At least I know you're not cheating.",
    "In fairness, most kids get that wrong too."
];

  useEffect(() => {
    const shuffledQuestions = [...ukHistoryQuestions]
  ...
  const restartQuiz = () => {
    const shuffled = [...ukHistoryQuestions]
      .sort(() => 0.5 - Math.random())
      .slice(0, 10)
      .map(q => ({
        ...q,
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-orange-50 p-8">
      ...
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold mb-2">UK History Quiz</h2>
        <p className="text-gray-700">How well do you know British history. Let's find out.</p>
      </div>
