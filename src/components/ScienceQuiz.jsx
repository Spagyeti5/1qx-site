...
export default function ScienceQuiz() {
  ...
  useEffect(() => {
    const shuffled = [...scienceFacts].sort(() => 0.5 - Math.random()).slice(0, 10);
  ...
  const restartQuiz = () => {
    const reshuffled = [...scienceFacts].sort(() => 0.5 - Math.random()).slice(0, 10);
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      <h1 className="text-3xl font-bold mb-2">Science True or False Quiz</h1>
      <p className="text-gray-700 mb-6 max-w-xl">
        Can you separate fact from fiction in the world of science? Tread carefully, it's weirder than you think.
      </p>
