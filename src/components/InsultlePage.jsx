  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-orange-50 p-4">
      ...
      <p className="text-gray-700 mb-6 text-center max-w-xl">
        Use your imagination to guess these genuine, often forgotten insults. Green is correct, yellow is the right letter in the wrong spot, and grey is incorrect. You don't need to guess real words.
      </p>
